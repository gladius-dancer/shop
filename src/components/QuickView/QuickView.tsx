                ...
                <div className="row">
                  ...
                  <div className="col-12 col-lg-7">
                    ...
                    <div className="share_wf mt-30">
                      ...
                      <div className="_icon">
                        <a href="src/components/QuickView/QuickView#"><i className="fa fa-facebook" aria-hidden="true"></i></a>
                        <a href="src/components/QuickView/QuickView#"><i className="fa fa-twitter" aria-hidden="true"></i></a>
                        <a href="src/components/QuickView/QuickView#"><i className="fa fa-pinterest" aria-hidden="true"></i></a>
                        <a href="src/components/QuickView/QuickView#"><i className="fa fa-google-plus" aria-hidden="true"></i></a>
                      </div>
                    </div>
                  </div>
                </div>
